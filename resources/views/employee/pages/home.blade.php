                    ...
                    <form action="{{ route('emp.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-12 text-end">
                                <button type="submit" class="btn btn-dark" name="btn-new" value="new">Save</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('emp.update', ['id' => $emp->id]) }}" method="POST">
                            ...
                            <div class="row mb-3">
                                <label for="edit-password" class="col-sm-4 col-form-label text-end">New Password</label>
                                <div class="col-sm-8">
                                    <input type="password"
                            ...
                            <div class="row mb-3">
                                <label for="edit-password_confirmation" class="col-sm-4 col-form-label text-end">Confirm
                                    Password</label>
                                <div class="col-sm-8">
                                    <input type="password"
